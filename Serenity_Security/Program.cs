...
builder.Services.AddHttpClient<NvdApiService>();
builder.Services.AddScoped<NvdApiService>();
...
builder
    ...
    .AddCookie(
        ...
        options =>
        {
            options.Cookie.Name = "Serenity_SecurityLoginCookie";
...
builder
    ...
    .AddEntityFrameworkStores<Serenity_SecurityDbContext>();

// allows passing datetimes without time zone data
AppContext.SetSwitch("Npgsql.EnableLegacyTimestampBehavior", true);

// allows our api endpoints to access the database through Entity Framework Core
builder.Services.AddNpgsql<Serenity_SecurityDbContext>(
    builder.Configuration["Serenity_SecurityDbConnectionString"]
);
